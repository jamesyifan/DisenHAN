...
def test(model, test_data_loader, topk, device):
    print('Start Test')
...
if __name__ == '__main__':
    ...
    if args.dataset == 'yelp':
        ...
        train_data_path = '../movielens_dataset/rates/train_data.pickle'
        valid_data_path = '../movielens_dataset/rates/valid_with_neg_sample.pickle'
        test_data_path = '../movielens_dataset/rates/test_with_neg_sample.pickle'
        adj_paths = []
        adj_names = ['adj_UI.pickle', 'adj_IA.pickle', 'adj_ID.pickle', 'adj_IC.pickle', 'adj_IG.pickle']
        for name in adj_names:
            adj_paths.append('../movielens_dataset/adjs/' + name)
        index_to_id_paths = []
        index_to_ids = []
        ...
        for name in index_to_id_names:
            index_to_id_paths.append('../movielens_dataset/adjs/' + name)
        for path in index_to_id_paths:
            with open(path, 'rb') as f:
                index_to_ids.append(pickle.load(f))
